...
const Footer = ({theme}) => {
  return (
    ...
    className='bg-slate-100 dark:bg-gray-900 pt-10 sm:pt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        {/* footer top */}
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
                ...
                <p>From strategy to rxecution, we carft digital solutions that move your business forward.</p>
        ...
        className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
            <p>Copyright © 2012 - 2026 TermsFeed®. All rights reserved.</p>
