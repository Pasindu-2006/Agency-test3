  ...
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
      ...
      viewport={{once:true}}
       ...
       className='inline-flex items-center gap-2 border rounded-full border-gray-300 p-1.5'>
      ...
      viewport={{once:true}}
       ...
       className='text-4xl sm:text-5xl md:text-[84px] font-medium xl:leading-23.75 max-w-5xl'>Turning imagination into <span className='bg-linear-to-r from-primary to-[#4d8cea] bg-clip-text text-transparent'>digital</span> impact.</motion.h1>
